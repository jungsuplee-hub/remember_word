...
function openHeaderMenu() {
  ...
  if (document.body.classList.contains('mobile-menu-open')) return;
  lastFocusedElementBeforeMenu = document.activeElement instanceof HTMLElement ? document.activeElement : headerMenuToggle;
  document.body.classList.add('mobile-menu-open');
  headerMenuToggle.setAttribute('aria-expanded', 'true');
  syncHeaderMenuAccessibility(true);
  const focusable = headerMenu.querySelector('a, button, input, select, textarea, [tabindex]:not([tabindex="-1"])');
